...
long long x,y,sp[100135][50],hsh[100135],deg[100135],cost[100135],P[100135],H[100135],state[100135],qs[100135],chain[100135],head[100135],w[100135],p[100135],cot[100135],posC[100135],pos[100135];
...
//    system("pause");
    sum=0;
    long long mn=1000000000000000000,tmp;
    for(i=0;i<edge.size();i++)
    {
        if(hsh[i])
            continue;
...
//        printf("%lld\n",max(deg[a],deg[b]));
        tmp=sum-max(adj[make_pair(a,p[a])],adj[make_pair(b,p[b])])+c;
